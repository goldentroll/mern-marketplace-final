...
Welcome to my coding course to build a marketplace website by MERN stack. In this course you will learn the essential tools and skills to design, develop and deploy a fully-function multi-vendor website using React and Redux in frontend and Node and MongoDB in backend.

Before diving into this course I am gonna say thank you Brad to give me this opportunity to share my experience in software engineering with your awesome community.

This is a practical coding course and you need to start coding along with me throughout this course. We will have a great coding adventure by doing these great stuff:

- build functional component by react
...
Feel free to take a look at the next lesson which is about what we will build in this course and implement it if it is along with your ambitions.
...
1. What we will build
   ...
   10. Order Screen
       ...
       3. Product Screen
   11. enable admin to manage products
   12. upload product images to server
...
10. Install Babel For ES6 Syntax
...
21. Sign-in Screen UI
    1. create SigninScreen
    2. render email and password fields
    3. style signin form
22. Sign-in Screen Backend
...
24. Create Progress Indicator and Alert Component
